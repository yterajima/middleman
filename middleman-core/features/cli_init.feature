Feature: Middleman CLI
  ...
  Scenario: Create a new project using full path(git@)
    When I run `middleman init MY_PROJECT -T git@github.com:middleman/middleman-templates-default.git` interactively
    And I type "y"
    And I type "y"
    And I type "y"
    And I type "y"
